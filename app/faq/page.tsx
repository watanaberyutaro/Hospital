  ...
  const faqCategories = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: `3割負担の場合、初診料は約1,000円前後です。これに検査や処置、薬局でお薬代が加わります。
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          • 健康保険証もしくはマイナンバーカード
          • お薬手帳（お持ちの方）
          ※生活保護受給者の方は医療券をお持ちください。（来院時にない場合は自費になります。）
          【あればお持ちください】
          • 紹介状
          • 検査結果
          • 医療証（お持ちの方）`
        ...
        },
        {
          ...
          answer: '症状が強い場合はお申し出ください。看護師が初期対応いたします。緊急対応が必要と判断された場合は優先的に診察することがございます。'
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          ご希望により鎮静剤を使用することで、苦痛なく検査を受けることができます。

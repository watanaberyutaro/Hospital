  ...
  const faqCategories = [
    {
      ...
      items: [
        ...
        {
          question: '駐車場の料金はかかりますか？',
          answer: '当院ではコインパーキングをご利用の患者様に、駐車料金を全額負担しております。受付で駐車券をご提示ください。'
        }
      ]
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          特に肝機能異常（GPT高値）、胸部X線での影、血糖値異常などは早期治療が重要です。`
        },
        {
      ...
      items: [
        {
          ...
          answer: `【診療時間】
          月・火・木・金: 9:00-12:30 / 15:00-17:30
          水・土: 9:00-12:30（午後休診）
          日・祝: 休診

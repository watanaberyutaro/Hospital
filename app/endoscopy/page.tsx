...
病理検査結果には2〜3週間かかる場合がございますので、後日外来で結果説明を行うこともございます。
      ...
      <section className="py-20 bg-primary/5">
        <div className="container mx-auto px-6">
          <SectionHeading
            title="内視鏡検査実績"
            subtitle="2003年から2025年までの検査件数推移"
          />
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <Card className="p-6">
                ...
                <div className="mt-4 pt-4 border-t">
                  <p className="text-center">
                    ...
                    <span className="text-2xl font-bold text-primary ml-2">16,301件</span>
                  </p>
                </div>
              </Card>
              ...
              <Card className="p-6">
                ...
                <div className="mt-4 pt-4 border-t">
                  <p className="text-center">
                    <span className="text-muted-foreground">累計実績：</span>
                    <span className="text-2xl font-bold text-accent ml-2">8,197件</span>
                  </p>
                </div>
              </Card>
            </div>
            <Card className="p-6 text-center bg-gradient-to-r from-primary/10 to-accent/10">
              ...
              <p className="text-4xl font-bold text-primary">24,498<span className="text-2xl">件以上</span></p>
              <p className="text-sm text-muted-foreground mt-2">（2003年〜2025年）</p>
            </Card>
          </div>
        </div>
      </section>
